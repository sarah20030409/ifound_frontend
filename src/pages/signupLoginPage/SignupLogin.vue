    ...
    <div v-if="isLogin">
      ...
      <form @submit.prevent="" class="flex justify-center">
        <div>
          ...
          <input id="account" class="FromInputStyle" type="text" required />
          <label for="password" class="MediumText">密碼：</label>
          <input id="password" class="FromInputStyle" type="password" required />
          <label for="passwordRepeat" class="MediumText">再重複一次密碼：</label>
          <input id="passwordRepeat" class="FromInputStyle" type="password" required />
